...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('/config e', [{'type': 'special_subcommand', 'subcommands': ['help', 'get', 'search', 'edit']}]),
        ('\\config ', [{'type': 'special_subcommand', 'subcommands': ['help', 'get', 'search', 'edit']}]),
        ('/config help', []),
        ('/config edit', []),
        ('/config edit ', []),
        ('/config get', []),
        ('/config get ', [{'type': 'config_property', 'prefix': ''}]),
        ('/config get main.sh', [{'type': 'config_property', 'prefix': 'main.sh'}]),
        ('\\config get warnings', [{'type': 'config_property', 'prefix': 'warnings'}]),
