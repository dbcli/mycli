...
def create_default_config(list_values: bool = True) -> ConfigObj:
    ...
    default_config_file = resources.files(mycli).joinpath('myclirc').open('r', encoding='utf-8')
...
def write_default_config(destination: str, overwrite: bool = False) -> None:
    ...
    default_config = resources.files(mycli).joinpath('myclirc').read_text(encoding='utf-8')
