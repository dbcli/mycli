...
class SQLCompleter(Completer):
    keywords = ['ACCESS', 'ADD', 'ALL', 'ALTER TABLE', 'AND', 'ANY', 'AS',
            ...
            'LIKE', 'LIMIT', 'LOCK', 'LOG', 'LOGS', 'LONG', 'MASTER',
            ...
            'OWNER', 'PASSWORD', 'PCTFREE', 'PORT', 'PRIMARY', 'PRIOR',
            'PRIVILEGES', 'PROCESSLIST', 'PURGE', 'QUOTE', 'RAW', 'RENAME',
            'REPAIR', 'RESOURCE', 'RESET', 'REVOKE', 'RIGHT', 'ROW', 'ROWID',
            'ROWNUM', 'ROWS', 'SELECT', 'SESSION', 'SET', 'SHARE', 'SHOW',
            'SIZE', 'SLAVE', 'SLAVES', 'SMALLINT', 'START', 'STOP',
